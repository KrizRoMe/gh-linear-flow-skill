...
3. Si faltan claves, pregúntamelas en una sola tanda, agrupadas. Usa valores por defecto razonables cuando aplique: `baseBranch` → "develop", `notifyRecipient` → "el equipo".
